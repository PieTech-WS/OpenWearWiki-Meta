...
| 设备                 | 设备代号 | Product                   | 分辨率   | 水平 DP | DPR | 圆角 | 可用空间 |
| -------------------- | -------- | ------------------------- | -------- | ------- | --- | ---- | -------- |
...
| 小米手环 11 NFC      | q66nfc   | Xiaomi Smart Band 11      | 212\*520 | 106     | 2   | 104  |          |
| 小米手表 H1          | n60      | ?                         | 466\*466 | 233     | 2   | 50%  |          |
| 小米手表 S1 Pro      | l61      | ?                         | 480\*480 | 240     | 2   | 50%  |          |
...
| 小米手表 S4 Sport    | n62s     | Xiaomi Watch S4 Sport     | 466\*466 | 233     | 2   | 50%  |          |
| 小米手表 S4 15 周年  | o62m     | marconi_o62m_watch        | 466\*466 | 233     | 2   | 50%  |          |
| 小米手表 S4 41mm     | o63      | Xiaomi Watch S4 41mm      | 466\*466 | ?       | 2.2 | 50%  |          |
| 小米手表 S5          | p62      | Xiaomi Watch S5 46mm      | 480\*480 | 240     | 2   | 50%  |          |
| 小米手表 S5 eSIM     | p62lte   | Xiaomi Watch S5 eSIM 46mm | 480\*480 | 240     | 2   | 50%  |          |
| 小米手表 S5 41mm         | q63      | Xiaomi Watch S5 41mm      | 466\*466 | 240     | 2   | 50%  |          |
| 小米手表 S5 41mm 透明版     | q63   | Xiaomi Watch S5 透明版 | 466\*466 | 240     | 2   | 50%  |          |
| 红米手表 4           | n65      | ?                         | 390\*450 | ?       | ?   | ?    |          |
...
指 file 等存储接口实际可使用的最大空间，超出此值后无法正常写入数据。上方的值为近似值，在实际使用中如果接近此值，有可能会使设备重启或者进入恢复出厂页面。根据规律，可用空间大约是内存值的四分之一。
