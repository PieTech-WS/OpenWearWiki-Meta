...
| [Wear OS by Google](https://yizigezi.github.io/OpenWearWiki/wearosbygoogle.html) | Google LLC          | PixelWatch系列，Galaxy Watch部分型号，<br />小米手表(XMWT01)，TicWatch Pro系列等                        | Lv4.                              |
...
| 湃心OS(PersimWearOS)                              | RT-Thread           | [vivo WATCH 2](https://yizigezi.github.io/OpenWearWiki/vivo-watch-2.html)        | Lv1/Lv0(vivo WATCH2)              |
| [Xiaomi HyperOS](https://yizigezi.github.io/OpenWearWiki/xiaomi-hyper-os.html)(Vela) | Xiaomi              | Xiaomi Watch S1 Pro, Xiaomi Watch S3及<br />后续产品                                         | Lv3.                              |
| [HarmonyOS(LiteOS/AOSP)](https://yizigezi.github.io/OpenWearWiki/harmonyos-watch.html) | HUAWEI              | 华为手表全系，手环7及以后产品                                                                         | Lv3.(LiteOS)<br />Lv4.(With AOSP) |
| OpenHarmony(海思方案)                               | OpenAtom Foundation | 诺希N18, Astrolink S                                                                      | Lv2.                              |
| GarminConnect                                   | 佳明/Garmin           | Garmin手表全系                                                                              | Lv2.(Unstable)                    |
| [ColorOS Watch](https://yizigezi.github.io/OpenWearWiki/coloroswatch.html) | OPPO                | OPPO Watch全系                                                                            | Lv4.                              |
| MIUI Watch(S1 Pro为[Xiaomi Vela](https://yizigezi.github.io/OpenWearWiki/xiaomivela.html)) | Xiaomi              | 小米手表除XMWT01，Color一代外所有产品                                                                | Lv4.(vela)                        |
| [ZeppOS](https://yizigezi.github.io/OpenWearWiki/zeppos.html) | 华米/Amazfit          | 详见[ZeppOS文档](https://docs.zepp.com/zh-cn/docs/reference/related-resources/device-list/) | Lv4S.                             |
